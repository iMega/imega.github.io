...
Сьюзан объясняет как работает чат на примере исследований, которое впервые представлено Джоном Дарли (John Darley) и
...
которые дали рецензию на товар, откуда они родом, какие у них вкусы, и вряд ли они похожи на нас, и тем не менее,
мы доверяем им.
